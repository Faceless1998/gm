...
<MobileView>
  ...
  <div className="overlay">
    <div className="overlay-content">
      <a href="#home" onClick={() => document.querySelector('.overlay').classList.remove('active')}>HOME</a>
      <a href="#listing" onClick={() => document.querySelector('.overlay').classList.remove('active')}>LISTING</a>
      <a href="#house" onClick={() => document.querySelector('.overlay').classList.remove('active')}>BLOCKS</a>
      <a href="#about" onClick={() => document.querySelector('.overlay').classList.remove('active')}>ABOUT</a>
      <a href="#price" onClick={() => document.querySelector('.overlay').classList.remove('active')}>PRICING</a>
      <a href="#contact" onClick={() => document.querySelector('.overlay').classList.remove('active')}>CONTACT US</a>
    </div>
  </div>
